...
async def nande_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def nande_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = nandeimage(filename=picture_name)
    main_image.resize(
