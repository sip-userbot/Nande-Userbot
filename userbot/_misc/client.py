    ...
    def ilhammansiz_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**Nande - Userbot Error report**\n\n"
            ...
            from .session import NandeBot, NandeBot2, NandeBot3, tgbot
            ...
            if pattern is not None:
                ...
                if edited:
                    NandeBot.add_event_handler(func, events.MessageEdited(**kwargs))
                NandeBot.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def register(
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            from .session import NandeBot, tgbot ,NandeBot2, NandeBot3
...
NandeUserbotSession.fast_download_file = download_file
NandeUserbotSession.fast_upload_file = upload_file
NandeUserbotSession.reload = restart_script
NandeUserbotSession.check_testcases = checking
