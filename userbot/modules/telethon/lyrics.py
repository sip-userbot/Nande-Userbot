...
async def _(event):
    ...
    nandeevent = await edit_or_reply(event, "`wi8..! I am searching your lyrics....`")
    ...
    if event.pattern_match.group(1):
        ...
        return await nandeevent.edit("`What I am Supposed to find `")
    song = ""
...
async def lyrics(lyric):
    ...
    try:
        ...
        songs = None
    if songs is None:
        return await nandeevent.edit(f"Song **{artist} - {song}** not found!")
