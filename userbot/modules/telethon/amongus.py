...
async def _(event):
    ...
    nandeevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await nandeevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await nandeevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    nandeevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await nandeevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
