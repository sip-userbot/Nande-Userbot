...
async def _(event):
    ...
    nande = await edit_or_reply(event, "recognizeing this media")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await nande.edit("unblock @Rekognition_Bot and try again")
            return
        if response.text.startswith("See next message."):
            ...
            await nande.edit(msg)
        else:
            await nande.edit("sorry, I couldnt find it")
