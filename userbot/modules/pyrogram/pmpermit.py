...
pmpicc = SqL.getdb("add_pm_thumb") or "https://telegra.ph/file/29f08e733515a6fb4c50d.jpg"
pmlimited = SqL.getdb("get_pm_spam_limit") or 4
...
"""
    if bot:
        ...
        try:
            nice = await client.get_inline_bot_results(bot=bot_username, query="pmNandeuserbot")
