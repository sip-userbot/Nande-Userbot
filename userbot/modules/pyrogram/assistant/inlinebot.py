...
from userbot import pyrobot, nandeversion, CMD_HELP, pyrotgbot as bot, XTRA_CMD_LIST, CMD_LIST
...
Petercord_version = nandeversion
...
"""
        ...
        await client.answer_inline_query(inline_query.id, cache_time=0, results=ok_s)
    elif string_given.startswith("pmnandeuserbot"):
        msg = (
              "❏ 𝐏𝐞𝐫𝐢𝐧𝐠𝐚𝐭𝐚𝐧!\n"
              ...
              "┌━━━━━━━━━━━━\n"
              "├❏ 𝐏𝐞𝐬𝐚𝐧 𝐨𝐭𝐨𝐦𝐚𝐭𝐢𝐬 𝐁𝐲 𝗡𝗮𝗻𝗱𝗲-𝐔𝐬𝐞𝐫𝐛𝐨𝐭\n"
              "└━━━━━━━━━━━━\n")
        bttn = [
            [
                InlineKeyboardButton(
                    text="Terima", callback_data=f"terimapm"
                )
            ],
            [
             InlineKeyboardButton(
        ...
        bttn = [
            [
                InlineKeyboardButton(
                    text="⚡ Menu", callback_data=f"make_cmd_buttons"
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
             InlineKeyboardButton(
                    text="🚫 Tutup", callback_data=f"cleuse"
                )
            ],
        ]
...
async def black_menu(client, cb):
    ...
    bttn = [
            ...
            [
                InlineKeyboardButton(
                    text="🏧 Data Nande-Userbot 🏧", callback_data=f"make_ilham_bot"
                )
            ],
            [
             InlineKeyboardButton(
